...
(function(e) {
    function n() { this._pieces = [], this._parts = [] }

    function r(e) { this.index = 0, this.dataBuffer = e, this.dataView = new Uint8Array(this.dataBuffer), this.length = this.dataBuffer.byteLength }

    function i() { this.bufferBuilder = new n }

    function s(e) { var t = e.charCodeAt(0); return t <= 2047 ? "00" : t <= 65535 ? "000" : t <= 2097151 ? "0000" : t <= 67108863 ? "00000" : "000000" }

    function o(e) { return e.length > 600 ? (new Blob([e])).size : e.replace(/[^\u0000-\u007F]/g, s).length }

    function u() { this._events = {} }

    function l() { u.call(this) }

    function c(e, t) { l.call(this), t = f.extend({ readDelay: 0, paused: !1 }, t), this._source = e, this._start = 0, this._readChunkSize = t.chunkSize || e.size, this._readDelay = t.readDelay, this.readable = !0, this.paused = t.paused, this._read() }
    ...
    function p(e, t) {
        ...
        u.call(this);
        var n = this;
        this._options = f.extend({ chunkSize: 40960 }, t), this.streams = {}, typeof e == "string" ? (this._nextId = 0, this._socket = new WebSocket(e)) : (this._nextId = 1, this._socket = e), this._socket.binaryType = "arraybuffer", this._socket.addEventListener("open", function() { n.emit("open") }), this._socket.addEventListener("error", function(e) {
            ...
            f.setZeroTimeout(function() {
                e = e.data;
                try { e = f.unpack(e) } catch (t) { return n.emit("error", new Error("Received unparsable message: " + t)) }
    ...
    var t = {};
    t.useBlobBuilder = function() { try { return new Blob([]), !1 } catch (e) { return !0 } }(), t.useArrayBufferView = !t.useBlobBuilder && function() { try { return (new Blob([new Uint8Array([])])).size === 0 } catch (e) { return !0 } }(), t.supportsBinaryWebsockets = function() { try { var e = new WebSocket("ws://null"); return e.onerror = function() {}, typeof e.binaryType != "undefined" ? !0 : !1 } catch (t) { return !1 } }(), e.binaryFeatures = t, e.BlobBuilder = window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder || window.BlobBuilder, n.prototype.append = function(e) { typeof e == "number" ? this._pieces.push(e) : (this.flush(), this._parts.push(e)) }, n.prototype.flush = function() {
        if (this._pieces.length > 0) {
            var e = new Uint8Array(this._pieces);
            t.useArrayBufferView || (e = e.buffer), this._parts.push(e), this._pieces = []
        }
    }, n.prototype.getBuffer = function() { this.flush(); if (t.useBlobBuilder) { var e = new BlobBuilder; for (var n = 0, r = this._parts.length; n < r; n++) e.append(this._parts[n]); return e.getBlob() } return new Blob(this._parts) }, e.BinaryPack = {
        unpack: function(e) { var t = new r(e); return t.unpack() },
        pack: function(e) {
            var t = new i;
            t.pack(e);
            var n = t.getBuffer();
        ...
        if (e < 128) { var t = e; return t }
        if ((e ^ 224) < 32) { var n = (e ^ 224) - 32; return n }
        var r;
    ...
    }, r.prototype.unpack_uint8 = function() { var e = this.dataView[this.index] & 255; return this.index++, e }, r.prototype.unpack_uint16 = function() {
        var e = this.read(2),
    ...
    }, r.prototype.unpack_int8 = function() { var e = this.unpack_uint8(); return e < 128 ? e : e - 256 }, r.prototype.unpack_int16 = function() { var e = this.unpack_uint16(); return e < 32768 ? e : e - 65536 }, r.prototype.unpack_int32 = function() { var e = this.unpack_uint32(); return e < Math.pow(2, 31) ? e : e - Math.pow(2, 32) }, r.prototype.unpack_int64 = function() { var e = this.unpack_uint64(); return e < Math.pow(2, 63) ? e : e - Math.pow(2, 64) }, r.prototype.unpack_raw = function(e) { if (this.length < this.index + e) throw new Error("BinaryPackFailure: index is out of range " + this.index + " " + e + " " + this.length); var t = this.dataBuffer.slice(this.index, this.index + e); return this.index += e, t }, r.prototype.unpack_string = function(e) {
        var t = this.read(e),
            n = 0,
            r = "",
            i, s;
    ...
    }, r.prototype.unpack_array = function(e) { var t = new Array(e); for (var n = 0; n < e; n++) t[n] = this.unpack(); return t }, r.prototype.unpack_map = function(e) {
        var t = {};
        for (var n = 0; n < e; n++) {
            var r = this.unpack(),
                i = this.unpack();
        ...
        return (n == 0 ? 1 : -1) * s
    }, r.prototype.read = function(e) { var t = this.index; if (t + e <= this.length) return this.dataView.subarray(t, t + e); throw new Error("BinaryPackFailure: read index out of range") }, i.prototype.getBuffer = function() { return this.bufferBuilder.getBuffer() }, i.prototype.pack = function(e) {
        var n = typeof e;
    ...
    }, i.prototype.pack_uint8 = function(e) { this.bufferBuilder.append(e) }, i.prototype.pack_uint16 = function(e) { this.bufferBuilder.append(e >> 8), this.bufferBuilder.append(e & 255) }, i.prototype.pack_uint32 = function(e) {
        var t = e & 4294967295;
    ...
    }, i.prototype.pack_int8 = function(e) { this.bufferBuilder.append(e & 255) }, i.prototype.pack_int16 = function(e) { this.bufferBuilder.append((e & 65280) >> 8), this.bufferBuilder.append(e & 255) }, i.prototype.pack_int32 = function(e) { this.bufferBuilder.append(e >>> 24 & 255), this.bufferBuilder.append((e & 16711680) >>> 16), this.bufferBuilder.append((e & 65280) >>> 8), this.bufferBuilder.append(e & 255) }, i.prototype.pack_int64 = function(e) {
    ...
    u.prototype.addListener = function(e, t, n, r) {
        ...
        function i() { r.removeListener(e, i), t.apply(this, arguments) }
        ...
        if (a(r)) {
            ...
            for (var s = 0, o = r.length; s < o; s++)
                if (r[s] === t || r[s].listener && r[s].listener === t) { i = s; break }
            if (i < 0) return this;
            r.splice(i, 1), r.length == 0 && delete this._events[e]
        } else(r === t || r.listener && r.listener === t) && delete this._events[e];
        return this
    }, u.prototype.off = u.prototype.removeListener, u.prototype.removeAllListeners = function(e) { return arguments.length === 0 ? (this._events = {}, this) : (e && this._events && this._events[e] && (this._events[e] = null), this) }, u.prototype.listeners = function(e) { return this._events[e] || (this._events[e] = []), a(this._events[e]) || (this._events[e] = [this._events[e]]), this._events[e] }, u.prototype.emit = function(e) {
        var e = arguments[0],
            t = this._events[e];
        if (!t) return !1;
    ...
    var f = {
        inherits: function(e, t) { e.super_ = t, e.prototype = Object.create(t.prototype, { constructor: { value: e, enumerable: !1, writable: !0, configurable: !0 } }) },
        extend: function(e, t) { for (var n in t) t.hasOwnProperty(n) && (e[n] = t[n]); return e },
        pack: BinaryPack.pack,
        unpack: BinaryPack.unpack,
        setZeroTimeout: function(e) {
            function r(r) { t.push(r), e.postMessage(n, "*") }

            function i(r) { r.source == e && r.data == n && (r.stopPropagation && r.stopPropagation(), t.length && t.shift()()) }
            var t = [],
    ...
    f.inherits(l, u), l.prototype.pipe = function(e, t) {
        function r(t) { e.writable && !1 === e.write(t) && n.pause && n.pause() }
        ...
        function a(e) { f(); if (this.listeners("error").length === 0) throw e }

        function f() { n.removeListener("data", r), e.removeListener("drain", i), n.removeListener("end", o), n.removeListener("close", u), n.removeListener("error", a), e.removeListener("error", a), n.removeListener("end", f), n.removeListener("close", f), e.removeListener("end", f), e.removeListener("close", f) }
        var n = this;
    ...
    }, f.inherits(c, l), c.prototype.pause = function() { this.paused = !0 }, c.prototype.resume = function() { this.paused = !1, this._read() }, c.prototype.destroy = function() { this.readable = !1, clearTimeout(this._timeoutId) }, c.prototype._read = function() {
        function t() { e._emitReadChunk() }
        var e = this,
            n = this._readDelay;
        ...
        if (e === 0) { this.readable = !1, this.emit("end"); return }
        var t = this._start + e,
    ...
    }, e.BlobReadStream = c, f.inherits(h, l), h.prototype._onDrain = function() { this.paused || this.emit("drain") }, h.prototype._onClose = function() {
        if (this._closed) return;
        this.readable = !1, this.writable = !1, this._closed = !0, this.emit("close")
    }, h.prototype._onError = function(e) { this.readable = !1, this.writable = !1, this.emit("error", e) }, h.prototype._onPause = function() { this.paused = !0, this.emit("pause") }, h.prototype._onResume = function() { this.paused = !1, this.emit("resume"), this.emit("drain") }, h.prototype._write = function(e, t, n) { if (this._socket.readyState !== this._socket.constructor.OPEN) return !1; var r = f.pack([e, t, n]); return this._socket.send(r) !== !1 }, h.prototype.write = function(e) { if (this.writable) { var t = this._write(2, e, this.id); return !this.paused && t } throw new Error("Stream is not writable") }, h.prototype.end = function() { this._ended = !0, this.readable = !1, this._write(5, null, this.id) }, h.prototype.destroy = h.prototype.destroySoon = function() { this._onClose(), this._write(6, null, this.id) }, h.prototype._onEnd = function() {
        if (this._ended) return;
        this._ended = !0, this.readable = !1, this.emit("end")
    }, h.prototype._onData = function(e) { this.emit("data", e) }, h.prototype.pause = function() { this._onPause(), this._write(3, null, this.id) }, h.prototype.resume = function() { this._onResume(), this._write(4, null, this.id) }, f.inherits(p, u), p.prototype.send = function(e, n) {
        var r = this.createStream(n);
        if (e instanceof l) e.pipe(r);
        else if (f.isNode === !0) Buffer.isBuffer(e) ? (new BufferReadStream(e, { chunkSize: this._options.chunkSize })).pipe(r) : r.write(e);
        else if (f.isNode !== !0)
            if (e.constructor == Blob || e.constructor == File)(new c(e, { chunkSize: this._options.chunkSize })).pipe(r);
            ...
            (new c(i, { chunkSize: this._options.chunkSize })).pipe(r)
        ...
        return n.on("close", function() { delete t.streams[e] }), this.streams[e] = n, n
        ...
        return r.on("close", function() { delete t.streams[n] }), this.streams[n] = r, r
    }, p.prototype.close = p.prototype.destroy = function() { this._socket.close() }, e.BinaryClient = p
})(this)